...
public interface CacheWrapper {
    ...
    */
   void setUp(String config, boolean isLocal, int nodeIndex, TypedProperties confAttributes, String remoteCache) throws Exception;
   ...
   CacheWrapper transactify();

    boolean populateTpcc(int numWarehouses, int slaveIndex, int numSlaves, long cLastMask, long olIdMask, long cIdMask);
}
