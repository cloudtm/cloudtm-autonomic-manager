...
public class NewOrderTransaction implements TpccTransaction {
   ...
   public static void registerGet(String key){

         //System.out.println("New Order Called registered Get "+key);
         registerKey(getMap,key);
   }

   public static void registerPut(String key){

         //System.out.println("New Order Called registered Put "+key);
