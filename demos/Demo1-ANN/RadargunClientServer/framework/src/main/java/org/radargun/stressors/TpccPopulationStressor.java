...
public class TpccPopulationStressor extends AbstractCacheWrapperStressor {
   ...
   private boolean populateOnOneCache;

   private boolean enablePopulate;
   ...
   public void performPopulationOperations(CacheWrapper w) throws Exception {
      ...
      new TpccPopulation(this.wrapper, this.numWarehouses, this.slaveIndex, this.numSlaves, this.cLastMask, this.olIdMask, this.cIdMask, this.populateOnOneCache, this.enablePopulate);
   ...
   public void setPopulateOnOneCache(boolean populateOnOneCache){
       this.populateOnOneCache = populateOnOneCache;
   }

   public void setEnablePopulate (boolean enablePopulate){
