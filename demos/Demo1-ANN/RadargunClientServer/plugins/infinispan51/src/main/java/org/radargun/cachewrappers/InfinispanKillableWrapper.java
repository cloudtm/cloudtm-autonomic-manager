...
public class InfinispanKillableWrapper extends InfinispanWrapper implements Killable {
   ...
   @Override
   public void setUp(String config, boolean isLocal, int nodeIndex, TypedProperties confAttributes, String remoteCache)
            throws Exception {
      super.setUp(config, isLocal, nodeIndex, confAttributes, remoteCache);
