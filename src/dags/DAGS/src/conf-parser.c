...
void print_configuration(simulation_conf *configuration) {
	...
	printf("\t average_net_delay: %f\n", configuration->server_conf.average_net_delay);
}
...
struct parse_table global_params[] = { { "num_clients", INT_T, offsetof(simulation_conf, num_clients) }, { "num_servers", INT_T, offsetof(simulation_conf, num_servers) }, { "cache_objects", INT_T,
		offsetof(simulation_conf, cache_objects) }, { "object_replication_degree", INT_T, offsetof(simulation_conf, object_replication_degree) }, { "start_stat_time", INT_T,
		offsetof(simulation_conf, start_stat_time) }, { NULL, NO_TYPE, 0 } };
...
struct parse_table client_params[] = { { "system_model", SYSTEM_MODEL_T, offsetof(struct _client_conf_t, system_model) }, { "tx_arrival_rate", DOUBLE_T,
		...
		{ "inter_tx_think_time", DOUBLE_T, offsetof(struct _client_conf_t, inter_tx_think_time) }, { "inter_tx_operation_think_time", DOUBLE_T,
				...
				"data_items_zipf_const", DOUBLE_T, offsetof(struct _client_conf_t, data_items_zipf_const) }, { "number_of_blocks", INT_T, offsetof(struct _client_conf_t, number_of_blocks) }, {
		...
		{ "tlm_print_stat", BOOL_T, offsetof(struct _client_conf_t, tlm_print_stat) }, { "tlm_verbose", BOOL_T, offsetof(struct _client_conf_t, tlm_verbose) }, { "client_verbose", BOOL_T,
				offsetof(struct _client_conf_t, client_verbose) }, { "print_execution_info", BOOL_T, offsetof(struct _client_conf_t, print_execution_info) }, { "client_print_stat", BOOL_T,
...
struct parse_table server_params[] = { { "replication_degree", INT_T, offsetof(struct _server_conf_t, replication_degree) }, { "max_servents_per_cpu", INT_T,
		...
		BOOL_T, offsetof(struct _server_conf_t, deadlock_detection_enabled) }, { "average_net_delay", DOUBLE_T, offsetof(struct _server_conf_t, average_net_delay) }, { "cc_print_stat", BOOL_T,
		offsetof(struct _server_conf_t, cc_print_stat) }, { "print_max_blocked_transactions", BOOL_T, offsetof(struct _server_conf_t, print_max_blocked_transactions) }, { "server_verbose", BOOL_T,
		offsetof(struct _server_conf_t, server_verbose) }, { "tlm_verbose", BOOL_T, offsetof(struct _server_conf_t, tlm_verbose) },
		{ "cc_verbose", BOOL_T, offsetof(struct _server_conf_t, cc_verbose) }, { NULL, NO_TYPE, 0 } };
