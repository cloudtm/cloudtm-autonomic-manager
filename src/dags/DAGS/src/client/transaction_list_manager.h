...
transaction_descriptor *create_new_tpcc_transaction(state_type *state, transaction_descriptor ** tx_list, int tx_id, double data_items_zipf_const);

// crea una transazione e la accoda
transaction_descriptor *create_new_transaction(state_type *state, transaction_descriptor ** tx_list, int tx_id, int data_item_access_distribution, double data_items_zipf_const);
