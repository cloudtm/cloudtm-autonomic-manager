...
package Tas2.logicalModel.solver;
...
public abstract class AbstractSolver implements Solver {
   ...
   public AbstractSolver(Configuration conf) {
      this.configuration = conf;
   }

   protected Tas2Configuration configuration() {
      return (Tas2Configuration) configuration;
   }
