 ...
 *         Date: 23/11/12
 */
public class ExtendedServiceRatesImpl implements ExtendedServiceRates {

   private CpuServiceTimes cpuServiceTimes;
   private NetServiceTimes netServiceTimes;

   public ExtendedServiceRatesImpl(CpuServiceTimes cpuServiceTimes, NetServiceTimes netServiceTimes) {
